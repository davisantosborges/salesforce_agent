...
TypeScript toolkit for configuring Salesforce orgs via Metadata API, Tooling API, and browser automation.

## Commands

```bash
npm test                    # 78 unit + 29 integration tests
...
.claude/skills/                                      # Claude Code skill docs
